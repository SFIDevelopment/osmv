...
//    /**
//     * Mapa Polski, Europy i Świata - DoCelu.pl (added by "maniek-ols") <p> <a
...
//
//    /**
//     * Darmowa Mapa Polski dla GPS Garmin - UMP-pcPL (added by "maniek-ols") <p>
...
//                    + "/" + tilex + "/" + tiley + ".png";
            String s = "http://s" + SERVER_NUM + ".outdooractive.com/" + mapName + "/map/" + zoom
                    + "/" + tilex + "/" + tiley + ".png";
...
//     * <td>all</td> <td>17</td> </tr> <tr> <td>toporaster2</td> <td>Topographic
//     * raster map 2 WMS</td> <td>all</td> <td>17</td> </tr> <tr> <td>europa</td>
...
//    }
    ...
    public static class Bergfex extends BaseTileProvider {
         ...
         */
        static final byte[] SERVER_IDS = {4, 5, 6, 7, 8};// {1, 2, /*3  ,*/ 4, 5};
        int SERVERNUM = 0;
        ...
        public String getTileUrlString(int tilex, int tiley, int zoom) {
            ...
            return baseurl + zoom + "/" + xBase + zoom + "_" + tilex + "_" + tiley + ".png";
        }
    }
