...
public class RadarView extends View  {
    ...
    public void setTarget(int latE6, int lonE6) {
        mTargetLat = latE6 / (double) GeoMathUtil.MILLION;
        mTargetLon = lonE6 / (double) GeoMathUtil.MILLION;
    }
    ...
    public void onLocationChanged(Location location) {
        ...
        if (useLocation) {
            ...
            db = GeoMathUtil.distanceAndBearing(mMyLocationLat, mMyLocationLon, mTargetLat,
                    mTargetLon);
            mDistance = db[0];
            mBearing = db[1];
//            mDistance = GeoMathUtils.distanceKm(mMyLocationLat, mMyLocationLon, mTargetLat,
//                    mTargetLon);
//    
//            mBearing = GeoMathUtil.bearing(mMyLocationLat, mMyLocationLon, mTargetLat,
//                    mTargetLon);
