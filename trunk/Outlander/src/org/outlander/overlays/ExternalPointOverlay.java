...
public class ExternalPointOverlay extends BasePointOverlay {
    ...
    public ExternalPointOverlay(final Context ctx,
    ...
    public void setLocation(final double latitude, final double longitude,
        ...
        point.poiPoint = new PoiPoint(((title != null) ? title : "Target"),
                ((address != null) ? address : "unknown"), new GeoPoint(
                        latitude, longitude), ExternalPointOverlay.ICON_ID);
        points.add(point);
