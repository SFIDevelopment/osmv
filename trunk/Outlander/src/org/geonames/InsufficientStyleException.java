 ...
 * 
 */
class InsufficientStyleException extends GeoNamesException {
    /**
     * 
     */
    private static final long serialVersionUID = 1349954678966567849L;

    InsufficientStyleException(final String msg) {
        super(msg);
    }
}
