...
public class FileUtils {
     ...
     * @return
     */
    public static boolean isLocal(final String uri) {
     ...
     * @return
     */
    public static File getPathWithoutFilename(final File file) {
        if (file != null) {
            if (file.isDirectory()) {
     ...
     * @return
     */
    public static File getFile(final String curdir, final String file) {
        String separator = "/";
        if (curdir.endsWith("/")) {
            separator = "";
        }
    ...
    public static File getFile(final File curdir, final String file) {
