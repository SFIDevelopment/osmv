...
public class WindInfoHandler {
    ...
    public final static int[]    red_arrows               = {
            R.drawable.arrow_n_red, R.drawable.arrow_ne_red,
            R.drawable.arrow_e_red, R.drawable.arrow_se_red,
            R.drawable.arrow_s_red, R.drawable.arrow_sw_red,
            R.drawable.arrow_w_red, R.drawable.arrow_nw_red, };

    public final static int[]    green_arrows             = {
            R.drawable.arrow_n_green, R.drawable.arrow_ne_green,
            R.drawable.arrow_e_green, R.drawable.arrow_se_green,
            R.drawable.arrow_s_green, R.drawable.arrow_sw_green,
            R.drawable.arrow_w_green, R.drawable.arrow_nw_green, };

    public final static int[]    yellow_arrows            = {
            R.drawable.arrow_n_yellow, R.drawable.arrow_ne_yellow,
            R.drawable.arrow_e_yellow, R.drawable.arrow_se_yellow,
            R.drawable.arrow_s_yellow, R.drawable.arrow_sw_yellow,
            R.drawable.arrow_w_yellow, R.drawable.arrow_nw_yellow, };
    ...
    public final static String   postfixs[]               = { "", "", "(max)",
            "°", "", "°C", "% huminity"                  };
    // (ave)
