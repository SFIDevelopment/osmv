...
public class ActionBarTabsPager extends FragmentActivity {
    ...
    protected void onCreate(final Bundle savedInstanceState) {
        ...
        mTabsAdapter
                .addTab(getSupportActionBar().newTab().setText("Übersicht"));
        mTabsAdapter.addTab(getSupportActionBar().newTab().setText("Karte"));
        mTabsAdapter.addTab(getSupportActionBar().newTab().setText("Autos"));
        mTabsAdapter.addTab(getSupportActionBar().newTab().setText("SMS in"));
        mTabsAdapter.addTab(getSupportActionBar().newTab().setText("SMS out"));

        // mTabsAdapter.addTab(tab1,
        // FragmentStackSupport.CountingFragment.class);
        // if (Build.VERSION.SDK_INT < Build.VERSION_CODES.ECLAIR) {
        // mTabsAdapter.addTab(tab2,
        // FragmentStackSupport.CountingFragment.class);
        // mTabsAdapter.addTab(tab3,
        // FragmentStackSupport.CountingFragment.class);
        // mTabsAdapter.addTab(tab4,
        // FragmentStackSupport.CountingFragment.class);
        // } else {
        // mTabsAdapter.addTab(tab2,
    ...
    public static class TabsAdapter extends FragmentPagerAdapter implements
        ...
        public TabsAdapter(final FragmentActivity activity,
                final ActionBar actionBar, final ViewPager pager) {
