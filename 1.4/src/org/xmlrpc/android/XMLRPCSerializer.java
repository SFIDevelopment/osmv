...
class XMLRPCSerializer implements IXMLRPCSerializer {
    static SimpleDateFormat dateFormat = new SimpleDateFormat(
                                               IXMLRPCSerializer.DATETIME_FORMAT);
    ...
    public void serialize(final XmlSerializer serializer, final Object object)
        ...
        if ((object instanceof Integer) || (object instanceof Short)
            ...
            serializer.startTag(null, IXMLRPCSerializer.TYPE_I4)
                    .text(object.toString())
                    .endTag(null, IXMLRPCSerializer.TYPE_I4);
        } else if (object instanceof Long) {
            serializer.startTag(null, IXMLRPCSerializer.TYPE_I8)
                    .text(object.toString())
                    .endTag(null, IXMLRPCSerializer.TYPE_I8);
        } else if ((object instanceof Double) || (object instanceof Float)) {
            serializer.startTag(null, IXMLRPCSerializer.TYPE_DOUBLE)
                    .text(object.toString())
                    .endTag(null, IXMLRPCSerializer.TYPE_DOUBLE);
        } else if (object instanceof Boolean) {
            final Boolean bool = (Boolean) object;
            final String boolStr = bool.booleanValue() ? "1" : "0";
            serializer.startTag(null, IXMLRPCSerializer.TYPE_BOOLEAN)
                    .text(boolStr).endTag(null, IXMLRPCSerializer.TYPE_BOOLEAN);
        } else if (object instanceof String) {
            serializer.startTag(null, IXMLRPCSerializer.TYPE_STRING)
                    .text(object.toString())
                    .endTag(null, IXMLRPCSerializer.TYPE_STRING);
        } else if ((object instanceof Date) || (object instanceof Calendar)) {
            final String dateStr = XMLRPCSerializer.dateFormat.format(object);
            serializer.startTag(null, IXMLRPCSerializer.TYPE_DATE_TIME_ISO8601)
                    .text(dateStr)
                    .endTag(null, IXMLRPCSerializer.TYPE_DATE_TIME_ISO8601);
        } else if (object instanceof byte[]) {
            final String value = new String(Base64Coder.encode((byte[]) object));
            serializer.startTag(null, IXMLRPCSerializer.TYPE_BASE64)
                    .text(value).endTag(null, IXMLRPCSerializer.TYPE_BASE64);
        } else if (object instanceof List) {
            serializer.startTag(null, IXMLRPCSerializer.TYPE_ARRAY).startTag(
                    null, IXMLRPCSerializer.TAG_DATA);
            ...
            serializer.endTag(null, IXMLRPCSerializer.TAG_DATA).endTag(null,
                    IXMLRPCSerializer.TYPE_ARRAY);
            ...
            final Iterator<Entry<String, Object>> iter = map.entrySet()
                    .iterator();
            while (iter.hasNext()) {
                ...
                serializer.startTag(null, IXMLRPCSerializer.TAG_NAME).text(key)
                        .endTag(null, IXMLRPCSerializer.TAG_NAME);
                serializer.startTag(null, IXMLRPCSerializer.TAG_VALUE);
    ...
    public Object deserialize(final XmlPullParser parser)
        ...
        if (hasType) {
            if (typeNodeName.equals(IXMLRPCSerializer.TYPE_INT)
                    || typeNodeName.equals(IXMLRPCSerializer.TYPE_I4)) {
                ...
                obj = parser.nextText();
                    ...
                    .equals(IXMLRPCSerializer.TYPE_DATE_TIME_ISO8601)) {
                final String value = parser.nextText();
                try {
                ...
                while (parser.getName().equals(IXMLRPCSerializer.TAG_MEMBER)) {
                    ...
                    parser.require(XmlPullParser.END_TAG, null,
                            IXMLRPCSerializer.TAG_MEMBER);
                    parser.nextTag();
                }
                parser.require(XmlPullParser.END_TAG, null,
                        IXMLRPCSerializer.TYPE_STRUCT);
                obj = map;
            } else {
