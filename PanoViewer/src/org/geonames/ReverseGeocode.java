 ...
 * workaround. Here is how I implemented it: try { possibleAddresses =
 * g.getFromLocation(location.getLatitude(), location.getLongitude(), 3); }
 * catch (IOException e) { if("sdk".equals( Build.PRODUCT )) { Log.d(TAG,
 * "Geocoder doesn't work under emulation."); possibleAddresses =
 * ReverseGeocode.getFromLocation(location.getLatitude(),
