...
public class WerteListFragment extends SherlockListFragment {
    ...
    public void onListItemClick(final ListView l, final View v,
         ...
         String text = makeText((entries.size() - 1) - position,false);
//        String text = makeText(position, false);
    ...
    private String makeText(final int index, final boolean forSpeach) {
        ...
        WindEntry entry = entries.get(index);
        ...
        text += "  "
                ...
                + " "
                + getResources().getStringArray(forSpeach ? R.array.speed_unit_title_tts : R.array.speed_unit_title)[conversionIx]
                + "  "
