/*
 * Copyright (C) 2012 Cyril Mottier (http://www.cyrilmottier.com) Licensed under
...
public class MapCalloutDrawable extends Drawable {
     ...
     * 
     * @param context
     *            The Context in which this {@link MapCalloutDrawable} will be
     *            used.
     */
    ...
    public int getIntrinsicHeight() {
        return Math.max(mLeftCapDrawable.getIntrinsicWidth(), Math.max(mBottomAnchorDrawable.getIntrinsicHeight(), mRightCapDrawable.getIntrinsicHeight()));
    }

    @Override
    public int getIntrinsicWidth() {
        // @formatter:off
        return mLeftCapDrawable.getIntrinsicWidth() + mBottomAnchorDrawable.getIntrinsicWidth() + mRightCapDrawable.getIntrinsicWidth();
        // @formatter:on
    }
    ...
    public int getChangingConfigurations() {
        // @formatter:off
        return super.getChangingConfigurations() | mLeftCapDrawable.getChangingConfigurations() | mBottomAnchorDrawable.getChangingConfigurations()
    ...
    private void updateBounds() {
        ...
        // @formatter:off
        mLeftCapDrawable.setBounds(selfBounds.left, selfBounds.top, selfBounds.left + leftCapWidth, selfBounds.bottom);

        mBottomAnchorDrawable.setBounds(selfBounds.left + leftCapWidth, selfBounds.top,
                selfBounds.left + leftCapWidth + mBottomAnchorDrawable.getIntrinsicWidth(), selfBounds.bottom);

        mRightCapDrawable.setBounds(selfBounds.left + leftCapWidth + mBottomAnchorDrawable.getIntrinsicWidth(), selfBounds.top, selfBounds.right,
                selfBounds.bottom);
        // @formatter:on
    }
