 ...
 * 
 * @author Nicolas Gramlich This class provides a way to convert from latitude
...
public class Mercator implements MathConstants {
    ...
    /**
     * Converts a Mercator-projected y-coordinate (projected latitude) to the
    ...
    /**
     * Converts a real Latitude to the Mercator-projected y-coordinate
    ...
    /**
     * Converts a Mercator-projected x-coordinate (projected longitude) to the
     * real longitude. This is only a approximation.
     */
    public static double x2lon(final double x) {
        return x * MathConstants.RAD2DEG;
    }

    /**
     * Converts a real longitude to the Mercator-projected x-coordinate
     * (projected longitude). This is only a approximation.
     */
    public static double lon2x(final double lon) {
        return MathConstants.DEG2RAD * lon;
    }

    // public static double[] fromMercatorProjection(final int x, final int y){
    // return new double[] {projectedToRealLat(y / 1E6), projectedToRealLon(x /
    // 1E6)};
    // }
    //
    // public static double[] fromMercatorProjection(final double x, final
    // double y){
    ...
    // dphi = PI_2 - 2 * Math.atan(ts * Math.pow((1.0 - con) / (1.0 + con),
    // COM)) - phi;
    // phi += dphi;
    // i++;
    // }
    ...
    // }
    //
    // public static double[] toMercatorProjection(final double aLatitude, final
    // double aLongitude) {
    // return new double[] {realToProjectedLat(aLatitude),
    // realToProjectedLon(aLongitude)};
    // }
    //
    // public static double[] toMercatorProjection(final int aLatitudeE6, final
    // int aLongitudeE6) {
    // return new double[] {realToProjectedLat(aLatitudeE6 / 1E6),
    // realToProjectedLon(aLongitudeE6 / 1E6)};
    // }
    //
