 ...
 * stationary.
 * 
 * This policy will dictate a policy based on a min, max and idle time. The
 * policy will dictate an interval bounded by min and max whic is half of the
 * idle time.
 * 
...
public class AdaptiveLocationListenerPolicy implements LocationListenerPolicy {
     ...
     *            Largest interval this policy will dictate, in milliseconds
     */
    public AdaptiveLocationListenerPolicy(final long min, final long max,
