...
public abstract class SectionedListViewAdapter extends BaseAdapter implements
    ...
    void setHasMorePagesListener(final HasMorePagesListener hasMorePagesListener) {
     ...
     */
    public void setInitialPage(final int initialPage) {
    ...
    public final View getView(final int position, final View convertView,
        ...
        final int section = getSectionForPosition(position);
        final boolean displaySectionHeaders = (getPositionForSection(section) == position);
     ...
     * call {@link SectionedListView#tellNoMoreData()} if there is no more
     * pages.
     * 
     * @param page
